          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-2xl font-serif italic text-settings-text">Manage Linear</h3>
                      ...
                      {syncResult.success ? (
                        <>
                          ...
                          <span className="text-[11px] font-medium opacity-80">
                            Bruno imported {syncResult.count} saved item{syncResult.count !== 1 ? 's' : ''} from Linear.
                          </span>
                        </>
                      ) : (
                        syncResult.message
              ...
              <div className="pt-2 border-t border-settings-border mt-2 space-y-3">
                {onConfigure && (
                  <button
                    onClick={onConfigure}
                    className="w-full py-3 bg-settings-card border border-settings-border text-settings-text rounded-xl text-xs font-black uppercase tracking-widest hover:bg-settings-card/70 transition-colors shadow-sm"
                  >
                    Configure Selected Teams
                  </button>
                )}
                {!isDisconnecting ? (
                  <button
