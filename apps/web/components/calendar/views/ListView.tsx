  ...
  if (groupedEvents.length === 0) {
    return (
      ...
      >
        ...
        <h3 className="text-xl font-black text-foreground mb-2">No upcoming events</h3>
      ...
      <div className="p-6 max-w-3xl mx-auto w-full space-y-10">
        {groupedEvents.map((group) => (
          <div key={group.day.toISOString()} className="space-y-4">
            <h2 className="text-lg font-black uppercase tracking-widest text-muted-foreground border-b border-border pb-2 sticky top-0 bg-card z-10">
