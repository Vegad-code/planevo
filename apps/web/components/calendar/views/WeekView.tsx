...
export default function WeekView({
  ...
  const handleDragEnd = useCallback(
    (eventId: string, deltaX: number, deltaY: number) => {
      ...
      // Apply both time and day changes
      const newStart = addDays(new Date(originalStart.getTime() + snappedDeltaMinutes * 60 * 1000), dayDelta);
