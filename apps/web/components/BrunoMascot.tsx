...
interface BrunoMascotProps {
  pose: BrunoPose;
  className?: string;
}

const POSE_MAP: Record<string, string> = {
  thinking: '/images/bruno/thinking.png',
  syncing: '/images/bruno/syncing.png',
  zen: '/images/bruno/zen.png',
  grumpy: '/images/bruno/grumpy.png',
  crystals: '/images/bruno/crystals.png',
  banner: '/images/bruno/banner.png',
  calendar: '/images/bruno/calendar.png',
  celebrate: '/images/bruno/zen.png', // Fallback to zen if celebrate.png is missing
};

export function BrunoMascot({ pose, className = '' }: BrunoMascotProps) {
  return (
