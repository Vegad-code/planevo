 ...
 * WeeklyReviewCard
 * 
 * Generates and displays a weekly productivity review from Bruno.
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted italic mt-0.5">
              {loading ? 'Bruno is crunching the numbers' : 'See what Bruno learned about you this week'}
            </p>
          </div>
          {loading && (
    ...
    >
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="bg-white/50 border border-brand-100 rounded-xl p-4">
          ...
          <p className="text-sm text-foreground font-medium italic">{review.bruno_learned}</p>
        </div>
