    ...
    >
      ...
      <AnimatePresence>
        {events.length === 0 && (
          ...
          >
            <div className="bg-[#1A1A1A]/90 backdrop-blur-xl p-6 rounded-[32px] border border-white/10 shadow-2xl flex flex-col items-center text-center pointer-events-auto">
